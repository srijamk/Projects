...
class Day_9_Part_1 {
    ...
    public static void main (String [] args) {
        ...
        while (index < 11035) {
            ...
            if (line.charAt(index) == ')') {
                int num_repeats = Integer.parseInt(line.substring(x + 1, index));
                int num_chars = Integer.parseInt(line.substring(opening + 1, x));
                
                for (int i = 0; i < num_repeats; i++) {
                    result += line.substring(index + 1, index + 1 + num_chars);
                }
                ok_print = true;
                index += (num_chars + 1);
            } else {
    ...
    public static void main (String [] args) {
        String line = "X(8x2)(3x3)ABCY";
        int count = 0;
        for (int i = 0; i < 15; i++) {
            if (line.charAt(i) == 'x') {
                int reps = Integer.parseInt("" + line.charAt(i + 1));
                int chars = Integer.parseInt("" + line.charAt(i - 1));
                count += reps * chars;
            }
        }
